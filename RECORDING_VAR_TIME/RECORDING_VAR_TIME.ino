...
const char* filenames[10] = {"/recording1.wav", "/recording2.wav", "/recording3.wav", "/recording4.wav",
      "/recording5.wav", "/recording6.wav", "/recording7.wav", "/recording8.wav", "/recording9.wav", "/recording.wav"};
    ...
    if (pos.x > 100 && pos.x < 220 && pos.y > 80 && pos.y < 180) {
      ...
      if (!button_rec_pressed) {
        if (!recording_enabled) {
          ...
          file = LittleFS.open(filenames[recording_index], FILE_WRITE);
          if(!file){
